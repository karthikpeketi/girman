	...
	return (
		<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-10">
			<div className="bg-white w-96 rounded-lg shadow-lg relative p-8">
				...
				<div className="text-custom-black mb-4">
					{/* Content */}

					<h2 className="text-3xl text-black font-semibold mb-1">Fetch Details</h2>
					<p className="text-light-grey font-[#71717A] mb-3">Here are the details of following employee.</p>
					<p>
